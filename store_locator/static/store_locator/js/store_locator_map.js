...
function location_search() {
    ...
    $.get(get_lat_long_url + "?q=" + search_value, function(data) {
        ...
        var search_url = get_near_locations_url;
...
function location_list_search() {
    ...
    $.get(get_lat_long_url + "?q=" + center_search, function(data) {
        ...
        var search_url = get_list_locations_url;
        $.getJSON(search_url, search_params, function(data) {
            $(".location_list").children().remove();
            $.each(data, function() {
                location_info = this;
...
function get_location_marker_click_listener(location_info, location_marker) {
    return function() {
        ...
        if (location_info.url != '') {
            content += "<br><strong>Website:</strong> <a href='http://" + location_info.url + "' target='_blank'>" + location_info.url + "</a>";
        }
